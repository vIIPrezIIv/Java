...
/**
 * Jersey REST client generated for REST resource:HotelsResource [hotels]<br>
 * USAGE:
 * <pre>
 *        RESTHotels client = new RESTHotels();
...
public class RESTHotels {
    ...
    public RESTHotels() {
        ...
        webTarget = client.target(BASE_URI).path("hotels");
    }
    ...
    public <T> T findAllHotels(Class<T> responseType) throws ClientErrorException {
