 ...
 * @author Ray
 */
@WebServlet(name = "Shift", urlPatterns = {"/Shift"})
public class Shift extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /**
         * Receives parameters from calender.jsp
         */
        ...
        /**
         * Makes a list of employees and then sends the list to shift.jsp with required attributes
         */
